...
exports.run = async (client, message, args) => {
    ...
    .then(() => {
        // Success message
        message.channel.send('<a:tick:965248158739365918> Giveaway rerolled!');
    })
    .catch((e) => {
        if(e.startsWith(`<a:across:964534449284972585> Giveaway with message ID ${giveaway.messageID} is not ended.`)){
            message.channel.send('<a:across:964534449284972585> This giveaway is not ended!');
        } else {
            console.error(e);
